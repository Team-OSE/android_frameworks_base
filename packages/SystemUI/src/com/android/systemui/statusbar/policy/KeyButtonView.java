...
import com.android.internal.util.ose.KeyButtonInfo;
import static com.android.internal.util.ose.NavbarConstants.*;
...
public class KeyButtonView extends ImageView {
    ...
    protected void doSinglePress() {
        ...
        if (mActions != null) {
            if (mActions.singleAction != null) {
                OSEActions.launchAction(mContext, mActions.singleAction);
            }
        }
    }
    ...
    private void doDoubleTap() {
        if (mHasDoubleAction) {
            removeCallbacks(mSingleTap);
            OSEActions.launchAction(mContext, mActions.doubleTapAction);
        }
    }
    ...
    protected void doLongPress() {
        if (mHasLongAction) {
            removeCallbacks(mSingleTap);
            OSEActions.launchAction(mContext, mActions.longPressAction);
            performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
